...
## 1. Tiếng Anh Học Thuật vs. Tiếng Anh Daily trong Chat
...
## 2. Nguyên tắc "No-Hello" (Cực kỳ quan trọng trong team IT)
...
## 3. Mẫu câu nhờ đồng nghiệp giúp đỡ (Daily Templates)
...
## 4. Cập nhật trạng thái công việc (Easy Patterns)
...
## 5. Các từ viết tắt thông dụng trên Slack/Teams (Mọi dev đều cần biết)

Trong giao tiếp hàng ngày qua chat, dân IT thường dùng từ viết tắt để gõ nhanh hơn:

- **PR:** Pull Request ("Please review my PR." - Review PR giúp tôi nhé.)
- **LGTM:** Looks Good To Me ("I reviewed your code, LGTM! 👍" - Tôi review code rồi, trông ổn đó!)
- **WIP:** Work In Progress ("This feature is still WIP." - Tính năng này vẫn đang được làm dở.)
- **AFK:** Away From Keyboard ("I will be AFK for 10 minutes." - Tôi rời màn hình khoảng 10 phút.)
- **OOO:** Out Of Office ("I am OOO today." - Hôm nay tôi nghỉ phép/không làm việc.)
- **ETA:** Estimated Time of Arrival/Completion ("What is the ETA for this fix?" - Dự kiến khi nào thì fix xong lỗi này?)
- **FYI:** For Your Information ("Just FYI, the staging server is down." - Thông tin thêm cho bạn biết là server staging đang bị sập.)
