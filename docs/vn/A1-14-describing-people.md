...
Dùng những từ này để miêu tả vẻ ngoài của con người.
...
Dùng những từ này để miêu tả cách cư xử của con người.
...
> **Ngoại hình**: `Chủ ngữ + có + [đặc điểm]`
>
> **Tính cách**: `Chủ ngữ + tính từ`
...
Trong **A1-15-review-unit3**, bạn sẽ ôn tập tất cả Unit 3.
