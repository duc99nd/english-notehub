    ...
    [
      {
        ...
        'options': ['X và Y quan trọng như nhau', 'X quan trọng hơn Y', 'X ít quan trọng hơn Y'],
      ...
      },
      {
        ...
        'options':
          ['Các phần phụ thuộc lẫn nhau', 'Các phần độc lập với nhau', 'Các phần không hoạt động'],
