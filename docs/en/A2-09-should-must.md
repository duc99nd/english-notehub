...
We use **should** and **must** as modal verbs. They come before the main verb.

## Should

Use **should** to give advice or recommendations.

> **Pattern**: `Subject + should + verb`
...
| Should               | Must                            |
| -------------------- | ------------------------------- |
| Advice (softer)      | Strong obligation (harder)      |
