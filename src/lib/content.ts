...
const FILE_META: Record<string, FileMeta> = {
  ...
  '66_phrasal_verbs_in_it': {
    ...
    titleEn: 'Common Phrasal Verbs in IT',
    subtitleEn: 'Essential two-word verbs for development, deployment, and meetings',
  ...
  '67_articles_a_an_the': {
    ...
    titleEn: 'Articles (A / An / The) in Tech English',
    subtitleEn: 'When to use a, an, the, or no article in IT writing and speaking',
  ...
  '72_business_english_developers': {
    ...
    titleEn: 'Business English for Developers',
    subtitleEn: 'Key phrases for reporting status, reproducing bugs, and explaining root causes',
